...
<body>
	...
	<?php else: ?>
		...
		<div id='navbar'>
			<div id='navbar-left'>
				<h1><?php echo linkto(CONFIG_TEAM_NAME, 'posts'); ?></h1>
				<?php echo linkto('New Post', 'new-post', NULL, 'get', 'btn btn-primary'); ?>
			</div>
			<div id='navbar-right'>
		...
		<div id='main'>
			<?php if($_REQUEST['PEANUTS']['flash']): ?>
				<div id='flash' class='text-center'><?php echo $_REQUEST['PEANUTS']['flash']; ?></div>
			<?php endif; ?>
			<?php include $template_path . $template_name; ?>
		</div>
